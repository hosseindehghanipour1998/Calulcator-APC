...
class MyScientificPage:
    ...
    def generatePage(self, root, canvas):
        ...
        btn_dot     = myButton(root, btnRow = 5, btnColumn = 4, btnText = "Theme", bgColor = "#3F4CFF", btnAction=lambda:myUtility.toggleDarkMode(root=root, canvas=canvas,inputLabel=monitor)) #nagative
